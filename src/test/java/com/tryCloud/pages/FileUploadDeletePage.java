...
public class FileUploadDeletePage extends DashboardPage {
    ...
    public void uploadFile(String fileName) {
        addIcon.click();
        uploadFile.sendKeys(System.getProperty("user.dir") + "/src/test/resources/files/" + fileName);
    ...
    public String isInDeletedFiles(String item) {
